...
def save_on_master(state, is_best, output_dir, epoch):
    if is_main_process():
...
def init_distributed_mode(args):
    if 'RANK' in os.environ and 'WORLD_SIZE' in os.environ:
        ...
        print('| distributed init (rank {}): {} {}'.format(args.rank, args.gpu, args.world_size))
...
def cosine_scheduler(base_value, final_value, epochs, niter_per_ep, warmup_epochs=0, start_warmup_value=0):
    ...
    warmup_iters = int(round(warmup_epochs * niter_per_ep))
    if warmup_epochs > 0:
