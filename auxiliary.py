...
def multi_head_attention_forward(query: Tensor,
    ...
    # attn_output_weights = entmax_bisect(attn_output_weights, alpha=1.1, dim=-1) + F.softmax(attn_output_weights, dim=-1)
    # attn_output_weights = entmax_bisect(attn_output_weights, alpha=1.1, dim=-1)
